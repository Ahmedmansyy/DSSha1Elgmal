...
public class DSSha1Elgmal {
    ...
    // if (A == false)
    // System.out.println("enter a Prime number again");
    // while (A == true) {
    // System.out.println("Enter Q");
    // q = cin.nextDouble();
    // System.out.println("Enter Alpha");
    // Alpha = cin.nextDouble();
    // System.out.println("Enter d");
    // d = cin.nextDouble();
    // B = Calc(Alpha, d, P);
    // System.out.println("Beta equal");
    ...
    // u2[i] = (w[i] * r) % q;
    // }
    // System.out.println("u2 equal u1 equal w equal s equal r equal ");
    // System.out.println(
    // " " + u2[9] + " " + u1[9] + " " + w[9] + " " + s[9] + " " + r);
    ...
    // System.out.println("validation equal ");
